...
stage2_dialog = Dialog(
    ...
    Window(
        Format(
            ...
            "• На выполнение всего этапа действует <b>общий таймер: {duration_str}</b>.\n"
    ...
    Window(
        Format(
            ...
            "На выполнение всех заданий отводится <b>{duration_str}</b> с момента нажатия кнопки «Да, начать».\n\n"
